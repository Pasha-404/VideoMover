...
public class MainActivity extends AppCompatActivity {
    ...
    private final BroadcastReceiver progressReceiver = new BroadcastReceiver() {
        @Override public void onReceive(android.content.Context context, Intent intent) {
            ...
            String msg = "Перенесено " + done + " из " + total + (fail > 0 ? (" (ошибок: " + fail + ")") : "");
    ...
    @Override protected void onStart() {
        ...
        IntentFilter pf = new IntentFilter(CopyService.ACTION_PROGRESS);
        pf.addCategory(Intent.CATEGORY_DEFAULT);
        pf.addAction(CopyService.ACTION_PROGRESS);
        registerReceiver(progressReceiver, new IntentFilter(CopyService.ACTION_PROGRESS), ContextCompat.RECEIVER_EXPORTED);

        registerReceiver(doneReceiver, new IntentFilter(CopyService.ACTION_DONE), ContextCompat.RECEIVER_EXPORTED);
    }
    ...
    private void onTransferAll() {
        ...
        Intent svc = new Intent(this, ru.pavelkuzmin.videomover.service.CopyService.class);
